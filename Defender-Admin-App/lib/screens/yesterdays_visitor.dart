...
//####################  Time  ###################
                    ...
                    onTap: () {
                      Navigator.pushNamed(
                        context,
                        YesterdayVisitorDetailView.screenID,
                        arguments: {
                          'name': queryResult.docs[index].data()['Name'],
                          'photoUrl': queryResult.docs[index].data()['Url'],
                          'surname': queryResult.docs[index].data()['Surname'],
                          'houseNumber':
                          ...
                          'vehicleNumber':
                              queryResult.docs[index].data()['Vehicle_Number'],
                          'purpose': queryResult.docs[index].data()['Purpose'],
                          'noOfVisitor':
                              queryResult.docs[index].data()['No_of_Visitor'],
                          'entryDate': DateFormat('dd MMM yyyy').format(
                              (queryResult.docs[index].data()['Entry_Time'])
                                  .toDate()),
                          'entryTime': DateFormat('hh:mm a').format(
                              (queryResult.docs[index].data()['Entry_Time'])
                                  .toDate()),
                          'mobileNumber':
                              queryResult.docs[index].data()['Mobile_Number'],
                        },
                      );
                    },
                  );
